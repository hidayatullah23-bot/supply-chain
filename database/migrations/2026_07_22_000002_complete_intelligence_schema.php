...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::table('ports', function (Blueprint $table) {
            ...
            if (! Schema::hasColumn('ports', 'source')) {
                $table->string('source')->default('local')->after('harbor_size');
            }
        });
        Schema::table('weather_forecasts', function (Blueprint $table) {
            ...
            if (! Schema::hasColumn('weather_forecasts', 'recorded_at')) {
        ...
        Schema::table('economic_indicators', function (Blueprint $table) {
            ...
            if (! Schema::hasColumn('economic_indicators', 'indicator_code')) {
                $table->string('indicator_code')->nullable()->index();
            }
        });
