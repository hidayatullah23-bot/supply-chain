    ...
    <form action="{{ route('warehouses.store') }}" method="POST" class="space-y-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" name="warehouse_code" value="{{ old('warehouse_code') }}" placeholder="Contoh: GDG-JKT01" class="w-full border rounded px-3 py-2 focus:ring-2 focus:ring-blue-500 outline-none" required>
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Nama Gudang *</label>
                <input type="text" name="warehouse_name" value="{{ old('warehouse_name') }}" placeholder="Contoh: Gudang Utama Jakarta" class="w-full border rounded px-3 py-2 focus:ring-2 focus:ring-blue-500 outline-none" required>
            </div>
        </div>
        ...
        <div>
            ...
            <textarea name="location" rows="3" placeholder="Alamat lengkap lokasi gudang..." class="w-full border rounded px-3 py-2 focus:ring-2 focus:ring-blue-500 outline-none">{{ old('location') }}</textarea>
        </div>
        ...
        <div class="flex justify-end gap-2 pt-2">
            <button type="reset" class="bg-gray-200 text-gray-700 px-4 py-2 rounded hover:bg-gray-300 transition">Reset</button>
            <button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition">Simpan Gudang</button>
        </div>
    </form>
</div>
